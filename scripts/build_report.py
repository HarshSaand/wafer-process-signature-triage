...
callout('Evidence boundary','This is a reproducible classifier and triage prototype evaluated on the shared 902-image Kaggle JPEG derivative. It is not TCAD simulation, root-cause diagnosis, or validation on A*STAR IME fab data.')
doc.add_page_break()
...
doc.add_heading('Semiconductor and Process TCAD problem',1)
